...
struct PremiumModalView: View {
    ...
    var body: some View {
                ...
                ScrollView {
                    VStack(spacing: 24) {
                        ...
                        VStack(alignment: .leading, spacing: 16) {
                            ...
                            PremiumFeatureRow(text: "2 additional color themes")
                            PremiumFeatureRow(text: "Stats export")
                        }
                        .padding()
        ...
        .onChange(of: themeManager.premiumUnlocked) { newValue in
            if newValue {
                presentationMode.wrappedValue.dismiss()
            }
        }
