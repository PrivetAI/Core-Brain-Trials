...
class ScoreStore: ObservableObject {
    ...
    static let allAchievements: [Achievement] = [
        ...
        Achievement(id: "level_75", title: "ELITE BREAKER", detail: "Reach level 75") { $0.highestLevel >= 75 },
        ...
        Achievement(id: "level_200", title: "PATTERN LORD", detail: "Reach level 200") { $0.highestLevel >= 200 },
